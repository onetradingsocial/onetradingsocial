// PageHead's right slot is a 4-tab .ad-tabs nav, and the rows are
// .ad-row-stack (meta line + wrapped message), not flat single-line rows.
  ...
  return (
    <SkeletonPage>
      ...
      <div style={{ display: 'grid', gap: 14 }}>
        <div className="ad-note" aria-hidden>
          <Bone w={58} />
