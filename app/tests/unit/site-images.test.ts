...
/** Shipped static pages. blog/<slug>.html (pre-rendered posts) is not listed:
 *  its markup is generated by scripts/build-blog.mjs, so extend this list when
 *  that generator emits dimensioned images. */
const PAGES = [...htmlIn(''), ...htmlIn('for'), ...htmlIn('compare')]
...
describe('site images: page list', () => {
  it('covers the shipped pages', () => {
    for (const p of ['index.html', 'pricing.html', 'blog.html', '404.html', 'terms.html', 'privacy.html', 'disclaimer.html', 'for/forex.html', 'compare/tradezella-alternative.html']) {
