...
(function () {
  ...
  if (navToggle) {
    const setMenu = (open) => {
      ...
      // Stop the page scrolling behind the panel while it's down.
      document.body.style.overflow = open ? "hidden" : "";
    };
    navToggle.addEventListener("click", () =>
      setMenu(!nav.classList.contains("open"))
    );
    // Any nav link closes the menu — same-page anchors would otherwise leave it open.
    ...
    const onBreak = (e) => { if (e.matches) setMenu(false); };
